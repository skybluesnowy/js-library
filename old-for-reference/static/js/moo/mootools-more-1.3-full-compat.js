...
// Load this file's selection again by visiting: http://mootools.net/more-rc/6788bf5a81afa9b75b3da50d88127772 
...
locale.inherits.sets=c.inherits.sets||{};}return locale;};})();Locale.define("en-GB","Date",{dateOrder:["date","month","year"],shortDate:"%d/%m/%Y",shortTime:"%H:%M"}).inherit("en-US","Date");
